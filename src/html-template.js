...
<div class="p">
    ...
    <div class="bdc-gray bdbs-s bdls-s bdrs-s bdts-s bdw-1 p-">Office Number: ${engineer.getGitHub()}</div>
</div>`;
    };
...
<div class="p">
    ...
    <div class="bdc-gray bdbs-s bdls-s bdrs-s bdts-s bdw-1 p-">Office Number: ${intern.getSchool()}</div>
</div>`;
    };
